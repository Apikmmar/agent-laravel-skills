...
Write-Host "Creating model '$ModelName' in module '$ModuleName'..." -ForegroundColor Cyan

php artisan module:make-model $ModelName $ModuleName

Pop-Location

Write-Host "Done. Proceed with filling in model fields and relationships." -ForegroundColor Green
